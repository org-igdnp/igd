...
function windowLoadInit() {
	...
	jQuery('form.contact-form').on('submit', function( e ){
		...
		.fail(function( data ) {
			jQuery($form).find('[type="submit"]').attr('disabled', false).parent().append('<span class="contact-form-respond highlight"> Please send your queries to <a href=mailto:igdnepal2000@gmail.com?subject="subject text">IGD Nepal</a>  to prevent from Spamming. Thank you!</span>');
		})
	});
